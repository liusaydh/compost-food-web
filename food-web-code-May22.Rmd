---
title: "Working model without nematodes, with (literature parameters, PRETTY interactive UI, calibrated parameters, literature state variables, 13C version). 13C state variables are not working on the sliders."
author: "Lucy"
date: "22/04/2022"
output:
...
e.bac      = 8.708494e-9
e.fun      = 3.670853e-9
e.bisp     = 1.007484526275729929e-14
e.sugars   = 1.8061e-12
e.co2      = 8.059371e-12
   ...
   CreateUI <- renderUI({  
    sidebarPanel(width = 12,
       tabsetPanel(id = "tabselected",
                   ...
                   tabPanel(strong("initial states, L+"), value = 8, helpText("initial state variables (amounts and biomasses), labelled")),
       ),
...
#be VERY CAREFUL with the indentation of conditional panels, otherwise nothing will ever work          
       ...
       conditionalPanel(condition = "input.tabselected == 8",
             fluidRow(
                   column(12,
                         sliderInput(inputId="BACTERIA.13C", label = "labelled bacterial biomass", min = 1e-9, max = 1e-7, step = 1e-10, value = state$BACTERIA.13C),                                                                            #1.284503e-08 is the default value
                         sliderInput(inputId="FUNGI.13C", label = "labelled fungal biomass", min = 1e-10, max = 1e-8, step = 1e-11, value = state$FUNGI.13C),                                                                                    #5.873365e-09 is the default value
                         sliderInput(inputId="A.BISPORUS.13C", label = "labelled A. bisporus biomass", min = 1e-18, max = 1e-16, step = 1e-19, value = state$A.BISPORUS.13C),                                                                    #8.419548e-17 is the default value
                         sliderInput(inputId="SUGARS.13C", label = "starting amount of labelled sugars in compost", min = 1e-12, max = 1e-10, step = 1e-13, value = state$SUGARS.13C),                                                           #1.550035e-11 is the default value
                         sliderInput(inputId="CO2.13C", label = "respired labelled carbon dioxide due to biological activities", min = 1e-18, max = 1e-16, step = 1e-19, value = state$CO2.13C)                                                  #8.059371e-17 is the default value
                   ),
             ),
       ),
